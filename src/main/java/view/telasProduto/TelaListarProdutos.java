 ...
 * @author Mario
 */
public class TelaListarProdutos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelTitulo.setText("PRODUTOS CADASTRADOS");
        ...
        jTableListaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Produto", "ID Fornecedor", "Nome", "Descrição", "Preço de Compra", "Preço de Venda", "Quantidade em Estoque"
            }
        ) {
