 ...
 * @author Mario
 */
public class TelaAtualizarFornecedor extends javax.swing.JPanel {

    private entidades.Fornecedor fornecedorAtual; // Armazena o funcionario localizado
    private boolean escutadorAtivo = false;  // Controla para não ativar o botão enquanto carrega os dados
    
    /**
     * Creates new form TelaAtualizarFornecedor
     */
    ...
    jRadioButtonCpf.addActionListener(e -> {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizarFornecedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
    });
}
    ...
    private void configurarEscutadoresDeModificacao() {
        ...
        jTextFieldRazaoSocial.getDocument().addDocumentListener(dl);
        jFormattedTextFieldCnpj.getDocument().addDocumentListener(dl);
        
        jComboBoxEstado.addActionListener(e -> verificarAlteracao());
    }

    private void verificarAlteracao() {
        if (escutadorAtivo && fornecedorAtual != null) {
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("ATUALIZAR FORNECEDORES");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(6, 6, 6)
                                        .addComponent(jLabelCnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(jLabelLogradouro, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
                                ...
                                .addGap(6, 6, 6)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jComboBoxEstado, 0, 299, Short.MAX_VALUE)
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        ...
        ControladorFornecedor.getInstanciaControladorFornecedor().atualizarFornecedorGrafico(
            Integer.parseInt(fornecedorAtual.getIdentificacao()),
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        fornecedorAtual = ControladorFornecedor.getInstanciaControladorFornecedor().buscarFornecedorPorIdOuCpf(tipoBusca, termo);

        if (fornecedorAtual == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Fornecedor não encontrado no sistema.", "Não Localizado", javax.swing.JOptionPane.ERROR_MESSAGE);
            jButtonAtualizar.setEnabled(false);
            return;
        }
        ...
        jTextFieldNome.setText(fornecedorAtual.getNome());
        jFormattedTextFieldCpf.setText(fornecedorAtual.getCpf());
        jFormattedTextFieldCpf.setEditable(false); // CPF não deve ser alterado em atualizações normais
        jTextFieldEmail.setText(fornecedorAtual.getEmail());
        jFormattedTextFieldTelefone.setText(fornecedorAtual.getTelefone());
        jTextFieldLogradouro.setText(fornecedorAtual.getEndereco().getLogradouro());
        jTextFieldNumero.setText(fornecedorAtual.getEndereco().getNumero());
        jTextFieldBairro.setText(fornecedorAtual.getEndereco().getBairro());
        jTextFieldCidade.setText(fornecedorAtual.getEndereco().getCidade());
        jComboBoxEstado.setSelectedItem(fornecedorAtual.getEndereco().getEstado());
        jFormattedTextFieldCep.setText(fornecedorAtual.getEndereco().getCep());
        jTextFieldRazaoSocial.setText(fornecedorAtual.getRepresentaEmpresaNome());
        jFormattedTextFieldCnpj.setText(fornecedorAtual.getRepresentaEmpresaCnpj());
